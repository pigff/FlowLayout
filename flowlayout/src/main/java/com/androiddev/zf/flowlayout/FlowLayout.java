package com.androiddev.zf.flowlayout;
...
public class FlowLayout extends ViewGroup {
    ...
    public void addItems(List<String> views) {
        for (int i = 0; i < views.size(); i++) {
            TextView textView = (TextView) LayoutInflater.from(getContext())
                    .inflate(R.layout.text_item, this, false).findViewById(R.id.tv_flow_layout);
            textView.setText(views.get(i));
            addView(textView);
        }
    ...
    public void setClick(final ChildClick click) {
